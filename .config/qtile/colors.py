...
# # opacity to the background bar
# def with_alpha(hex_color, alpha="cc"):  # cc ~ 80% opacity
...
#             return [
#                 [
#                     with_alpha(wal["special"]["background"]),
#                     with_alpha(wal["special"]["background"]),
#                 ],
#                 [wal["special"]["foreground"], wal["special"]["foreground"]],
#                 [wal["colors"]["color0"], wal["colors"]["color0"]],
#                 [wal["colors"]["color1"], wal["colors"]["color1"]],
#                 [wal["colors"]["color2"], wal["colors"]["color2"]],
#                 [wal["colors"]["color3"], wal["colors"]["color3"]],
#                 [wal["colors"]["color4"], wal["colors"]["color4"]],
#                 [wal["colors"]["color5"], wal["colors"]["color5"]],
#                 [wal["colors"]["color6"], wal["colors"]["color6"]],
#                 [wal["colors"]["color7"], wal["colors"]["color7"]],
#             ]
#     except Exception:
#         return Nord  # fallback


# Choose the active scheme here
